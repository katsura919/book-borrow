          ...
          <tbody>
            {currentRequests.map((request) => (
              <tr key={request.req_id}>
                ...
                <td>
                  {/* Show due date for the first book in the list (assuming all books have the same due date) */}
                  {request.books.length > 0 ? request.books[0].due_date : 'N/A'}
                </td>
                <td>{request.overdue_days } days</td>
                <td>
                  <button
